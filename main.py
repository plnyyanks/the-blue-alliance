...
from controllers.ajax_controller import AccountInfoHandler, AccountRegisterFCMToken, AccountFavoritesHandler, AccountFavoritesAddHandler, AccountFavoritesDeleteHandler, \
      YouTubePlaylistHandler, AllowedApiWriteEventsHandler, FMSMatchNumberToEventKeyHandler
...
app = webapp2.WSGIApplication([
      ...
      RedirectRoute(r'/_/match-keys/<event_key>/<desired_comp_level>', FMSMatchNumberToEventKeyHandler, 'translate-key', strict_slash=True, methods=['POST']),
